 ...
 * Generated at: 2019-12-20 23:03:35 UTC
...
final boolean DEBUG = false;
	...
	try
	{
		...
		sql  = "INSERT INTO usuario (ID_TdU, Username, Pssword, Correo, ID_D, Seed) VALUES (4,'"+us+"','"+pw+"','"+email+"',"+ID_TdU+", uuid())";
		System.out.println(sql);
		stmt2.executeUpdate(sql);
		
		sql3 = "SELECT Seed FROM usuario WHERE Username = '"+us+"'  AND Pssword = '"+pw+"'";
		...
		out.println("[{\"LOGEdit\": \"Succesful\",\"Seed\":\""+rid+"\"}]");
