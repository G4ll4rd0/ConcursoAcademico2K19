 ...
 * Generated at: 2019-12-20 02:51:31 UTC
...
final boolean DEBUG = false;
	...
	try
	{
		...
		sql  = "SELECT Seed FROM usuario WHERE (Username = '"+us+"'  AND Pssword = '"+pw+"') OR (Correo = '"+us+"' AND Pssword = '"+pw+"')";
		...
		if (rs.next())
		{
			...
			out.println("[{\"LOGIN\":\"succesful\", \"Seed\":\""+rid+"\"}]");
		}else{
